...
<head>
  ...
  <title>PAS Admin - Tables Employees</title>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <div class="mb-4">
            <h1 class="h3 mb-0 text-gray-800">Tables Employees</h1>
          </div>
          ...
          <div class="container">
            <div class="card shadow mb-4">
              <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Tables Employees</h6>
              </div>
              <div class="card-body">
                <?php
                if (isset($_SESSION["loggedin"]) && $_SESSION["loggedin"] === true) {
                  echo '<a href="add_employe.php" class="btn btn-primary mb-3"><i class="fa fa-plus"></i> Add Data
                    Employe</a>';
                }
                ...
                if ($result = mysqli_query($link, $sql)) {
                  if (mysqli_num_rows($result) > 0) {
                    ...
                    while ($row = mysqli_fetch_array($result)) {
                      ...
                      echo "<a href='data_employe.php?id=" . $row['id'] . "' class='mr-3'><i class='fas fa-eye'></i></a>";
                      if (isset($_SESSION["loggedin"]) && $_SESSION["loggedin"] === true) {
                        echo "<a href='edit_employe.php?id=" . $row['id'] . "' class='mr-3'><i class='fas fa-edit'></i></a>";
                        echo "<a class='openDeleteModal' href='#deleteModalPopUp' data-toggle='modal' 
                          data-target='#deleteModalPopUp' data-id=" . $row["id"] . "><i class='fas fa-trash-alt'></i></a>";
                      }
                      echo "</td>";
                      echo "</tr>";
                      $id++;
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">Ready to delete this Employe?</h5>
          ...
          <div class="modal-footer">
            <input type="hidden" name="id" id="valueInput" />
