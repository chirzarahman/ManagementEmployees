...
<head>
    ...
    <title>PAS Admin - Data Employe</title>
                            ...
                            <div class="col-md-8">
                                <div class="card shadow mb-4">
                                    <div class="card-header py-3">
                                        <h3 class="m-0 font-weight-bold text-primary">View Data Employe</h3>
                                    </div>
                                    <div class="card-body">
                                        <?php
                                        if (isset($_SESSION["username"])) {
                                            echo '<div class="mt-4">
                                                    <p class="font-weight-bold" style="color: black;">Name</p>
                                                    <p>' . $row["name"] . '</p>
                                                </div>';
                                            echo '<div class="mt-4">
                                            ...
                                            echo '<div class="mt-4">
                                                    <p class="font-weight-bold" style="color: black;">Salary</p>
                                                    <p>Rp. ' . $row["salary"] . '</p>
                                                </div>';
                                            echo '<div class="mt-4">
                                                    <p class="font-weight-bold" style="color: black;">Department</p>
                                                    <p>' . $row["department"] . '</p>
                                                </div>';
                                            echo '<div class="mt-4">
                                                    <p class="font-weight-bold" style="color: black;">Position</p>
                                                    <p>' . $row["position"] . '</p>
                                                </div>';
                                            echo '<div class="mt-4">
                                                    <p class="font-weight-bold" style="color: black;">Allowance</p>
                                                    <p>Rp. ' . $row["allowance"] . '</p>
                                                </div>';
                                        } else {
                                            echo '<div class="mt-4">
                                                    <p class="font-weight-bold" style="color: black;">Name</p>
                                        ...
                                        ?>
                                        <a href="table.php" name="add" class="btn btn-light float-right">Back</a>
                                    </div>
                                </div>
                            </div>
                        </div>
